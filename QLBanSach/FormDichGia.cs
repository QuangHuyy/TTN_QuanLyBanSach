...
namespace QLBanSach
{
    public partial class FormDichGia : Form
    {
        ...
        private void themDichGia_Click_1(object sender, EventArgs e)
        {
            ...
            SqlCommand kiemTraTrung = new SqlCommand("select * from DichGia where TenDG='" + textTenDG.Text + "'");
            ...
            int check = (int)kiemTraTrung.ExecuteScalar();
                ...
                else
                {
                    ...
                    {
                         kiemTraTrung = new SqlCommand("insert into " + "DichGia " + "values('" + textTenDG.Text + "')");
